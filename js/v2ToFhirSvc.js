    ...
    return {
      ...
      validateBundleDEP: function (validationServer, bundle) {
        ...
        bundle.entry.forEach(function (entry) {
          if (entry.resource) {
            let resource = entry.resource;
            let url =
              validationServer.url + resource.resourceType + "/$validate";
      ...
      makeGraphCanonical: function (bundle) {
        ...
        refs.forEach(function (ref) {
          hashRefsByResource[ref.source.id] =
            hashRefsByResource[ref.source.id] || [];

          hashRefsByResource[ref.source.id].push({
            path: ref.path,
            url: ref.url,
            type: ref.target.resourceType,
          });
          ...
          if (!targetNodeIndex) {
            ...
            arNodes.push({
              id: targetNodeIndex,
              label: ref.target.resourceType,
              shape: "box",
              color: objColours[ref.target.resourceType],
              resource: ref.target,
            });
          }
...
*/
        ...
        allReferences.forEach(function (ref) {
          ...
          if (centralResourceId) {
            ...
            if (
              ref.src.normalizedId == centralResourceId &&
              options.showOutRef
            ) {
            ...
            if (
              targetNode &&
              targetNode.normalizedId == centralResourceId &&
              options.showInRef
            ) {
        ...
        if (centralResourceId) {
          ...
          if (!options.recursiveRef) {
            ...
            arEdges.forEach(function (edge) {
              if (
                edge.from == centralResourceNodeId ||
                edge.to == centralResourceNodeId
              ) {
                ar.push(edge);
              }
            });
          ...
          angular.forEach(node, function (value, key) {
            ...
            if (angular.isArray(value)) {
              value.forEach(function (obj, inx) {
                ...
                if (obj) {
                  //somehow null's are getting into the array...
                    ...
                    if (thing.indexOf("urn:uuid") !== -1) {
                      ...
                      if (thing.indexOf("http") == 0) {
                        ...
                        if (serverRoot) {
                          ...
                          refs.push({
                            path: lpath,
                            reference: serverRoot + obj.reference,
                          });
                        } else {
                          refs.push({ path: lpath, reference: obj.reference });
                        }
                ...
                if (value.reference.indexOf("urn:uuid") !== -1) {
                  ...
                  if (value.reference.indexOf("http") == 0) {
                    ...
                    if (serverRoot) {
                      ...
                      refs.push({
                        path: lpath,
                        reference: serverRoot + value.reference,
                        index: index,
                      });
                    } else {
                      refs.push({
