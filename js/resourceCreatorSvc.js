      ...
      return {
        getPatientOrSubjectReferenceED: function () {
          ...
          if (
            ...
            this.currentProfile.snapshot.element
          ) {
            for (
              var i = 0;
              i < this.currentProfile.snapshot.element.length;
              i++
            ) {
              ...
              if (ar.length == 2) {
                if (
                  ar[1].toLowerCase() == "patient" ||
                  ar[1].toLowerCase() == "subject"
                ) {
                  return ed;
                  break;
                }
        ...
        findPatientsByName: function (name, oauthAccessToken) {
          ...
          supportSvc
            .getAllResourcesFollowingPaging(
              qry,
              null,
              oauthAccessToken,
        ...
        findPatientsByIdentifier: function (identifier) {
          ...
          var identifierSystem =
            appConfigSvc.config().standardSystem.identifierSystem;
        ...
        getJsonFragmentForDataType: function (dt, results, stuVersion) {
          ...
          switch (dt) {
            case "Money":
              var qty = {
                value: results.money_amount,
                unit: results.money_units,
              }; //sep2017 - was units
            ...
            case "Timing":
              ...
              if (results.timing.freq_max) {
                timing.repeat.frequencyMax = parseFloat(
                  results.timing.freq_max,
                );
              }
            ...
            case "Range":
              ...
              var text =
                "Between " + st.value + " and " + en.value + " " + st.unit;
            ...
            case "Annotation":
              var anot = {
                text: results.annotation.text,
                authorString: results.annotation.authorString,
              };
            ...
            case "CodeableConcept":
              ...
              if (cc && angular.isString(cc)) {
                try {
                  ...
                  alert(
                    "There was an error saving the CodeableConcept. Likely the response from theTerminology" +
              ...
              if (cc) {
                ...
                if (results.ccDirectSystem && results.ccDirectCode) {
                  ...
                  newCC.coding.push({
                    ...
                    code: results.ccDirectCode,
                    display: results.ccDirectDisplay,
                  });
                }
              }
            ...
            case "Reference":
              if (results.resourceItem) {
                ...
                if (results.resourceItemText) {
                  ...
                  v.display =
                    ResourceUtilsSvc.getOneLineSummaryOfResource(
                      selectedResource,
                    );
                }
            ...
            case "Identifier":
              var v = {
                system: results.identifier_system,
                value: results.identifier_value,
              };
            ...
            case "Period":
              ...
              var display =
                "From" + moment(results.date_start).format("YYYY-MM-DD");
        ...
        getPossibleChildNodes: function (ed, treeData) {
          ...
          if (
            ...
            alert(
              "This profile is not valid! It is either missing altogether, or doesn't have a valid snapshot element",
            );
            deferred.reject();
            return deferred.promise;
          }
          ...
          angular.forEach(
            ...
            function (elementDef) {
              ...
              if (
                elPath.substr(0, pathLength) == path &&
                ar.length == dotCount + 1
              ) {
                ...
                if (propertyName == "extension") {
                  ...
                  if (elementDef.myData && elementDef.myData.isExtension) {
                    ...
                    if (
                      !canAddChild(
                        elementDef.path,
                        dataHash,
                        elementDef.myData.extensionDefUrl,
                      )
                    ) {
                      ...
                      elementDef.myData.displayClass =
                        elementDef.myData.displayClass.replace(" noAdd", "");
                    }
                    ...
                    if (elementDef.type && elementDef.type[0].profile) {
                      ...
                      var profileUrl = Utilities.getProfileFromType(
                        elementDef.type[0],
                      ); //the Url of the profile

                      updateFromProfileDefinition(
                        queries,
                        elementDef,
                        profileUrl,
                      ); //will add to the list of async queries...
                  ...
                  if (
                    exclusions.indexOf(propertyName) == -1 ||
                    (dotCount !== 1 && propertyName == "text")
                  ) {
                    elementDef.myData = {
                      canAddChild: true,
                    ...
                    if (
                      elementDef.type &&
                      elementDef.type[0].code == "BackboneElement"
                    ) {
                    ...
                    if (elementDef.max != "0") {
                      ...
                      if (elementHash[extensionPath] && !isBBE(elementDef)) {
                        ...
                        for (
                          var i = 0;
                          i < elementHash[extensionPath].length;
                          i++
                        ) {
                          ...
                          if (el.type) {
                            el.type.forEach(function (typ) {
                              if (typ.profile) {
                                ...
                                extensionED.myData.displayClass =
                                  "elementExtension";
                                ...
                                extensionED.myData.extendedElement.parentName =
                                  ar[ar.length - 1]; //the name of the element being extended
                                ...
                                extensionED.myData.extendedElement.isComplex =
                                  complexDataType; //todo - look this up based on the datatype...
                                ...
                                extensionED.myData.extendedElement.isParentMultiple =
                                  that.canRepeat(elementDef); //false;        //todo find out from the parent ED
                ...
                if (url) {
                  ...
                  for (var i = 0; i < pathWithData.values.length; i++) {
                    ...
                    if (
                      ...
                      v.item.ed &&
                      v.item.ed.myData &&
                      v.item.ed.myData.extensionDefUrl == url
                    ) {
                      return false;
                      break;
                    }
              ...
              GetDataFromServer.findConformanceResourceByUri(url).then(
                ...
                function (err) {
                  modalService.showModal(
                    ...
                    {
                      bodyText:
                        "function: updateFromProfileDefinition - error retrieving " +
                        url,
                    },
                  );
                },
        ...
        buildResource: function (type, treeObject, treeData, config) {
          ...
          function addChildrenToNode(resource, node, text) {
            ...
            if (
              typeof lnode.fragment != "undefined" &&
              lnode.fragment != null
            ) {
              ...
              if (angular.isArray(resource)) {
                alert(
                  "array passed  - This is an error, please tell the author of clinFHIR!",
                );
              } else {
                ...
                if (propertyName == "extension") {
                  ...
                  if (lnode.ed.myData.extendedElement) {
                    ...
                    angular.forEach(resource, function (value, key) {
                      ...
                      if (key == parentName) {
                        ...
                        if (lnode.ed.myData.extendedElement.isComplex) {
                          ...
                          resource[elementName].extension.push(
                            extensionFragment,
                          );
                        }
                    ...
                    if (!processed) {
                      ...
                      var parentCR =
                        lnode.ed.myData.extendedElement.isParentMultiple;
                      if (parentCR) {
                        //can repeat
                        ...
                        if (lnode.ed.myData.extendedElement.isComplex) {
                          ...
                          resource[parentName].extension.push(
                            extensionFragment,
                          );
                        } else {
                          var elementName = "_" + parentName;
                ...
                if (ed && ed.type) {
                  if (ed.type[0].code == "BackboneElement") {
                    ...
                    if (childNodeHash.isComplexExtension) {
                      ...
                      var complexExt = {
                        url: analysis.complexExtension.url,
                        extension: [],
                      };
        ...
        getProfileDEP: function (type) {
          ...
          $http.get("artifacts/" + type + ".json").then(function (data) {
          ...
          switch (dt) {
            ...
            case "Quantity":
              ...
              GetDataFromServer.getExpandedValueSet("ucum-common").then(
                ...
                function (err) {
                  scope.showWaiting = false;
                  alert(
                    "Unable to get the UCUM codes, you can still enter them manually",
                  );
                  console.log(err);
                },
              );
            ...
            case "Reference":
              ...
              if (!RenderProfileSvc.isUrlaBaseResource(resourceProfile)) {
                ...
                //todo **** not wrking ****
                alert(
                  "Sorry, referencing profiled resources is not yet supported...",
                );
                return;

                scope.profileUrlInReference = resourceProfile; // ??? changes may ct referenceProfile;

                GetDataFromServer.findConformanceResourceByUri(
                  referenceProfile,
                ).then(
                  //will go to the current conformance server
                  function (profile) {
                    var resourceType = profile.constrainedType; //  Utilities.getResourceTypeFromUrl();
                    scope.resourceType = resourceType;
                    scope.selectedReferenceResourceType =
                      RenderProfileSvc.getResourceTypeDefinition(resourceType); //  scope.resourcetypes[resourceType];
                    ...
                    scope.resourceList =
                      RenderProfileSvc.getResourcesSelectListOfType(
                        allResources,
                        resourceType,
                        profile.url,
                      );
                  ...
                  function (err) {
                    alert(
                      "Unable to retrieve the StructureDefinition for " +
                        referenceProfile,
                    );
                  },
                );
                ...
                if (resourceType == "Resource") {
                  ...
                  scope.uniqueResources =
                    RenderProfileSvc.getUniqueResources(allResources);
                } else {
                ...
                scope.selectedReferenceResourceType =
                  RenderProfileSvc.getResourceTypeDefinition(resourceType);
                ...
                if (
                  !scope.selectedReferenceResourceType ||
                  scope.selectedReferenceResourceType.reference
                ) {
            ...
            case "Coding":
              ...
              var valueSetReference =
                RenderProfileSvc.getUniqueResources(element);

              results.coding = null;
              if (valueSetReference) {
                Utilities.getValueSetIdFromRegistry(
            ...
            case "CodeableConcept":
              ...
              if (element.binding) {
                ...
                var valueSetUri =
                  RenderProfileSvc.getValueSetUriFromBinding(element);
                if (valueSetUri) {
                  ...
                  var valueSetReference =
                    RenderProfileSvc.getValueSetReferenceFromBinding(element);
                    ...
                    Utilities.getValueSetIdFromRegistry(
                      ...
                      function (vsDetails) {
                        ...
                        if (scope.vsDetails && scope.vsDetails.type == "list") {
                          ...
                          // delete scope.valueSet;
                          //scope.showWaiting = true;
                          GetDataFromServer.getExpandedValueSet(
                            scope.vsDetails.id,
                          )
                            .then(
                              //get the expanded vs
                  ...
                  Utilities.getValueSetIdFromRegistry(
                    ...
                    function (vsDetails) {
                      ...
                      if (vsDetails && vsDetails.id) {
                        ...
                        GetDataFromServer.getExpandedValueSet(vsDetails.id)
                          .then(function (vs) {
        ...
        cleanResource: function (treeData) {
          ...
          treeData.forEach(function (item) {
            ...
            if (arParents.indexOf(parent) == -1) {
              ...
              if (objId[parent]) {
                //and the parent does actually exist...
        ...
        getProfileDisplay: function (url) {
          ...
          GetDataFromServer.getConformanceResourceByUrl(url).then(
            function (profile) {
              var lst =
                profileCreatorSvc.makeProfileDisplayFromProfile(profile).lst;
        ...
        createConformanceQualityReport: function (conf) {
          ...
          conf.rest[0].resource.forEach(function (res) {
            ...
            if (!res.profile) {
              lstIssue.push({
                level: "warning",
                display:
                  "The " + res.type + " type does not have a profile element",
              });
            } else {
              ...
              if (!profileUrl) {
                lstIssue.push({
                  ...
                  display:
                    "The " +
                    res.type +
                    " type has a profile element, but no reference",
                });
              } else {
          ...
          function getExtension(res, extensionUrl) {
            ...
            var deferred = $q.defer();
            GetDataFromServer.findConformanceResourceByUri(extensionUrl)
              .then(
                function (extensionDefinition) {
                  arExtensions.push({
                    url: extensionUrl,
                    ed: extensionDefinition,
                  }); //this the uri for an extension
                },
                function (err) {
                  lstIssue.push({
                    level: "error",
                    display:
                      "The " +
                      res.type +
                      " type has a reference to an extension of " +
                      extensionUrl +
          ...
          function getProfile(res, profileUrl) {
            var deferred = $q.defer();
            GetDataFromServer.findConformanceResourceByUri(profileUrl)
              .then(
                function (profile) {
                ...
                function (err) {
                  lstIssue.push({
                    ...
                    display:
                      "The " +
                      res.type +
                      " type has a profile reference of " +
                      profileUrl +
                      " which can't be loaded",
                  });
                },
          ...
          if (profile && profile.snapshot && profile.snapshot.element) {
            profile.snapshot.element.forEach(function (element) {
              ...
              if (display.myStuff.name.length > 50) {
                display.myStuff.name =
                  display.myStuff.name.substr(0, 47) + "...";
              }
                  ...
                  element.type.forEach(function (typ) {
                    ...
                    if (typ.profile) {
                      ...
                      GetDataFromServer.findConformanceResourceByUri(
                        ...
                        function (data) {
                          var analysis =
                            Utilities.analyseExtensionDefinition(data);
                          //console.log(analysis)
                          if (analysis.isCoded) {
                          ...
                          if (analysis.referenceTypes) {
                            ...
                            display.myStuff.dataTypeDescription =
                              "This is reference to another resource";
                      ...
                      display.myStuff.notePoint =
                        display.myStuff.notePoint.replace(/\./g, "_");
                    } else {
                    ...
                    if (typ.profile) {
                      typ.profile.forEach(function (url) {
                        ...
                        details.specification =
                          "http://hl7.org/fhir/" + details.display;
        ...
        saveNewProfileDEP: function (profileName, model, baseProfile, isEdit) {
          ...
          if (fhirVersion == 3) {
            if (!isEdit) {
              ...
              var profileUrl =
                config.servers.conformance + "StructureDefinition/" + profileId;
            ...
            if (item.data && item.data.ed) {
              ...
              if (ed.myMeta) {
                if (ed.myMeta.remove) {
                  ...
                  SDsToSave.push(
                    saveStructureDefinition(extensionId, extensionSD).then(
                      function () {
          ...
          SDsToSave.push(
            saveStructureDefinition(profileId, sd).then(
              function () {
          ...
          $q.all(SDsToSave).then(
            ...
            function (err) {
              alert(
                "Error saving profile and/or extension definitions " +
                  angular.toJson(err),
              );
              deferred.reject(err);
            },
        ...
        checkExtensionDefinitionsAreOnServer: function (
          serverUrl,
          arExtensions,
        ) {
            ...
            queries.push(
              GetDataFromServer.findConformanceResourceByUri(
                ...
                function (err) {
                  ...
                  delete ext.sdef;
                  console.log(
                    "Error retrieving " + ext.url + " " + angular.toJson(err),
                  );
                },
              ),
            );
        ...
        checkValueSetsAreOnServer: function (serverUrl, arValueSets) {
          ...
          arValueSets.forEach(function (item) {
            ...
            if (
              item.binding &&
              item.binding.valueSetReference &&
              item.binding.valueSetReference.reference
            ) {
            ...
            function (resource) {
              ...
              GetDataFromServer.findConformanceResourceByUri(
                ...
                function (oldResource) {
                  ...
                  var url =
                    targetUrl + resource.resourceType + "/" + resourceId;
        ...
        createGraphAroundSingleResourceInstance: function (
          resource,
          references,
          graphData,
        ) {
          ...
          var baseNode = {
            ...
            title: that.createResourceLabel(resource),
            shape: "box",
          };
          ...
          references.outwardLinks.forEach(function (ref) {
            if (ref.resource) {
              ...
              var node = {
                id: baseId + ctr,
                label: ref.resource.resourceType,
                title: that.createResourceLabel(ref.resource),
                shape: "box",
              }; //todo here is where we'll need to find if already added
        ...
        createGraphOfProfile: function (profile, options) {
          ...
          profile.snapshot.element.forEach(function (ed, inx) {
            ...
            if (
              ar.length > 1 &&
              elementsToDisable.indexOf(ar[ar.length - 1]) > -1
            ) {
              include = false;
            }
            ...
            if (include) {
              ...
              if (ed.type) {
                ...
                ed.type.forEach(function (typ) {
                  ...
                  if (
                    ["code", "Coding", "CodeableConcept"].indexOf(typ.code) > -1
                  ) {
                    //isCoded = true;
                    node.label += " C";
                  }
              ...
              if (inx == 0) {
                ...
                var baseTypeForModel =
                  appConfigSvc.config().standardExtensionUrl.baseTypeForModel;
                var ext1 = Utilities.getSingleExtensionValue(
                  profile,
                  baseTypeForModel,
                );
        ...
        createGraphOfInstances: function (
          allResources,
          includePatient,
          hashShowResourceTypes,
        ) {
          var that = this;
          var deferred = $q.defer();
          ...
          allResources.forEach(function (resource, inx) {
            ...
            if (resource.id) {
              ...
              var node = {
                id: inx,
                label: that.createResourceLabel(resource),
                shape: "box",
              };
          ...
          allResources.forEach(function (resource, inx) {
            ...
            if (resource.id) {
              if (resource.id.indexOf("urn:") > -1) {
                ...
                thisNodeId =
                  objNodes[resource.resourceType + "/" + resource.id];
              }
        ...
        createTimeLine: function (
          ...
          if (
            ...
            conditionsBundle.entry.length > 0
          ) {
            conditionsBundle.entry.forEach(function (entry) {
              var resource = entry.resource;
              objCondition["Condition/" + resource.id] = {
                resource: resource,
                count: 0,
              };
            });
              ...
              if (resource.period && resource.period.start) {
                ...
                if (resource.diagnosis) {
                  resource.diagnosis.forEach(function (dx) {
                    if (
                      dx.condition &&
                      dx.condition.reference &&
                      objCondition[dx.condition.reference]
                    ) {
          ...
          return {
            items: items,
            groups: new vis.DataSet(arGroups),
            ...
            function (data) {
              ...
              GetDataFromServer.findConformanceResourceByUri(
                ...
                function (profile) {
                  ...
                  if (!edList) {
                    deferred.reject(
                      "Sorry, the profile definition for this resource on the Conformance server is missing the snapshot",
                    );
                  } else {
            ...
            $q.all(queries).then(
              function () {
                ...
                angular.forEach(insertPoint, function (ext) {
                  ...
                  ext.analysis.complexExtension.contents.forEach(
                    function (item, inx) {
                      ...
                      profile.snapshot.element.splice(
                        ext.inx + inx + 1,
                        0,
                        child,
                      );
        ...
        registerSuccessfulResourceCreated: function (
          resourceId,
          resource,
          patient,
          user,
          ...
          var vo = {
            ...
            server: appConfigSvc.getCurrentDataServer().url,
            date: date,
        ...
        clearResourcesCreatedList: function () {
          if ($localStorage.createdResources) {
            ...
            if ($localStorage.createdResources.length > 5) {
              var ar = [],
                len = $localStorage.createdResources.length;
              for (var i = 0; i < 5; i++) {
