...
angular
  ...
  .service("appConfigSvc", function ($localStorage, $http, $timeout, $q) {
    ...
    defaultConfig.standardExtensionUrl.vsDirectConcept =
      "http://clinfhir.com/fhir/StructureDefinition/vsDirectConcept";

    defaultConfig.standardExtensionUrl.edMappingComment =
      "http://clinfhir.com/fhir/StructureDefinition/edMappingComment";
    defaultConfig.standardExtensionUrl.mapToModel =
      "http://clinfhir.com/fhir/StructureDefinition/mapToModel";
    defaultConfig.standardExtensionUrl.baseTypeForModel =
      "http://clinfhir.com/fhir/StructureDefinition/baseTypeForModel";
    defaultConfig.standardExtensionUrl.docrefDescription =
      "http://clinfhir.com/fhir/StructureDefinition/docrefDescription";
    defaultConfig.standardExtensionUrl.simpleExtensionUrl =
      "http://clinfhir.com/fhir/StructureDefinition/simpleExtensionUrl";
    defaultConfig.standardExtensionUrl.clinFHIRCreated =
      "http://clinfhir.com/fhir/StructureDefinition/cfAuthor";
    defaultConfig.standardExtensionUrl.userEmail =
      "http://clinfhir.com/StructureDefinition/userEmail";

    defaultConfig.standardExtensionUrl.scenarioProvenance =
      "http://clinfhir.com/StructureDefinition/scenarioProvenance";
    defaultConfig.standardExtensionUrl.scenarioNote =
      "http://clinfhir.com/StructureDefinition/scenarioNote";
    defaultConfig.standardExtensionUrl.provenanceTargetUrl =
      "http://clinfhir.com/StructureDefinition/provenanceTargetUrl";
    defaultConfig.standardExtensionUrl.discriminatorUrl =
      "http://clinfhir.com/StructureDefinition/discriminatorUrl";
    defaultConfig.standardExtensionUrl.conceptMapUrl =
      "http://clinfhir.com/StructureDefinition/conceptMapUrl";

    defaultConfig.standardExtensionUrl.resourceTypeUrl =
      "http://clinfhir.com/StructureDefinition/resourceTypeUrl";
    defaultConfig.standardExtensionUrl.qPath =
      "http://clinfhir.com/StructureDefinition/qPathUrl";
    defaultConfig.standardExtensionUrl.qMult =
      "http://clinfhir.com/StructureDefinition/qMultUrl";
    defaultConfig.standardExtensionUrl.igEntryType =
      "http://clinfhir.com/StructureDefinition/igEntryType";

    defaultConfig.standardExtensionUrl.qItemDescription =
      "http://clinfhir.com/fhir/StructureDefinition/qItemDescription";
    defaultConfig.standardExtensionUrl.fhirPath =
      "http://clinfhir.com/fhir/StructureDefinition/fhirPath";
    defaultConfig.standardExtensionUrl.editor =
      "http://clinfhir.com/fhir/StructureDefinition/editor";
    defaultConfig.standardExtensionUrl.igDocumentation =
      "http://hl7.org/fhir/StructureDefinition/implementationguide-page";
    defaultConfig.standardExtensionUrl.cfpubIgRoot =
      "http://clinfhir.com/fhir/StructureDefinition/cfpubIgRoot";

    defaultConfig.standardExtensionUrl.usageGuide =
      "http://clinfhir.com/fhir/StructureDefinition/usageGuideUrl";
    defaultConfig.standardExtensionUrl.legacy =
      "http://clinfhir.com/fhir/StructureDefinition/legacy";

    defaultConfig.standardExtensionUrl.examples =
      "http://clinfhir.com/fhir/StructureDefinition/examples";
    defaultConfig.standardExtensionUrl.references =
      "http://clinfhir.com/fhir/StructureDefinition/references";

    defaultConfig.standardExtensionUrl.misuse =
      "http://clinfhir.com/fhir/StructureDefinition/misuse";
    defaultConfig.standardExtensionUrl.edStatus =
      "http://clinfhir.com/fhir/StructureDefinition/edStatus";

    //defaultConfig.standardExtensionUrl.igEntryUrl = 'http://clinfhir.com/StructureDefinition/igEntryUrl';

    defaultConfig.standardExtensionUrl.path =
      "http://clinfhir.com/fhir/StructureDefinition/path";
    defaultConfig.standardExtensionUrl.instanceAuthor =
      "http://clinfhir.com/fhir/StructureDefinition/instanceAuthor";
    defaultConfig.standardExtensionUrl.lmReviewReason =
      "http://clinfhir.com/fhir/StructureDefinition/lmReviewReason";
    defaultConfig.standardExtensionUrl.lmElementLink =
      "http://clinfhir.com/fhir/StructureDefinition/lmElementLink";
    defaultConfig.standardExtensionUrl.autoExpand =
      "http://clinfhir.com/fhir/StructureDefinition/autoExpand";
    defaultConfig.standardExtensionUrl.enableComments =
      "http://clinfhir.com/fhir/StructureDefinition/enableComments";

    defaultConfig.standardExtensionUrl.canonicalUrl =
      "http://clinfhir.com/fhir/StructureDefinition/canonicalUrl";

    defaultConfig.standardSystem.identifierSystem =
      "http://clinfhir.com/fhir/NamingSystem/identifier";
    defaultConfig.standardSystem.practitionerIdentifierSystem =
      "http://clinfhir.com/fhir/NamingSystem/practitioner";
    defaultConfig.standardSystem.listTypes =
      "http://clinfhir.com/fhir/CodeSystem/listTypes";
    defaultConfig.standardSystem.bundleIdentifierSystem =
      "http://clinfhir.com/fhir/NamingSystem/bundleIdentifier";

    defaultConfig.standardCode.lmPalette =
      defaultConfig.standardSystem.listTypes + "|lmPalette";
    ...
    defaultConfig.servers.data =
      "https://fhir.s37vcloskatg.static-test-account.isccloud.io/";
    ...
    defaultConfig.defaultTerminologyServerUrl =
    ...
    defaultConfig.terminologyServers.push({
      name: "Grahames STU2 Server",
      version: 2,
      url: "http://test.fhir.org/r2/",
    });
    defaultConfig.terminologyServers.push({
      name: "Grahames STU3 Server",
      version: 3,
      url: "http://test.fhir.org/r3/",
    });

    defaultConfig.terminologyServers.push({
      name: "Public HAPI STU3 server",
      version: 3,
    ...
    defaultConfig.terminologyServers.push({
      name: "Ontoserver",
      url: "https://ontoserver.csiro.au/stu3-latest/",
      version: 3,
    });
    defaultConfig.terminologyServers.push({
      name: "Ontoserver-PC",
      url: "https://primarycare.ontoserver.csiro.au/fhir/",
      version: 3,
    });

    defaultConfig.allKnownServers.push({
      name: "InterSystems FHIR Server R4",
      version: 4,
    ...
    defaultConfig.allKnownServers.push({
      name: "Vonk R4 server",
      url: " https://vonk.fire.ly/R4/",
      version: 4,
      everythingOperation: false,
    });
    ...
    defaultConfig.allKnownServers.push({
      name: "Telstra Health R4 server",
      url: "http://sqlonfhir-stu3.azurewebsites.net/fhir/",
      version: 4,
      everythingOperation: true,
    });
...
*/
    ...
    defaultConfig.allKnownServers.push({
      name: "csiroProject",
      version: 3,
      url: "http://home.clinfhir.com:8030/baseDstu3/",
      everythingOperation: true,
    });
    defaultConfig.allKnownServers.push({
      name: "nzProject",
      version: 3,
      url: "http://home.clinfhir.com:8040/baseDstu3/",
      everythingOperation: true,
    });
    defaultConfig.allKnownServers.push({
      name: "nzProjectR4",
      version: 4,
      url: "http://home.clinfhir.com:8054/baseR4/",
      everythingOperation: true,
    });
    ...
    defaultConfig.allKnownServers.push({
      name: "HSPC Tutorial",
      version: 3,
      url: "https://api-v8-stu3.hspconsortium.org/ClinFHIRTutorial/open/",
      everythingOperation: false,
    });
    ...
    defaultConfig.allKnownServers.push({
      name: "HSPC-COF-R4",
      version: 4,
      url: "https://api.logicahealth.org/CoFsandboxR4/open/",
      everythingOperation: true,
    });
    ...
    return {
      ...
      addServer: function (svr, isTerminology) {
        ...
        for (var i = 0; i < defaultConfig.allKnownServers.length; i++) {
          if (defaultConfig.allKnownServers[i].url == svr.url) {
            alert(
              "There is already a server with this url: " +
                angular.toJson(defaultConfig.allKnownServers[i]),
            );
            return;
          }
        }
      ...
      checkConsistency: function () {
        ...
        config.allKnownServers.forEach(function (svr) {
          ...
          if (config.servers.conformance == svr.url) {
            tmp.push(svr);
          }
        });
        ...
        if (tmp.length < 2 || tmp[0].version !== tmp[1].version) {
          ...
          $localStorage.config.servers.terminology =
            config.defaultTerminologyServerUrl;
          ...
          if (s.version == version) {
            ...
            if (!foundServer) {
              ...
              if (that.getCurrentTerminologyServer().version !== version) {
                ...
                console.log(
                  "setting the terminology server to " + s.url,
                  "appConfig:config",
                );
              }
            }
      ...
      getCurrentDataServer: function () {
        ...
        return {
          url: $localStorage.config.servers.data,
          name: $localStorage.config.servers.data,
        };
      ...
      addToRecentPatient: function (patient) {
        ...
        for (var i = 0; i < $localStorage.recentPatient.length; i++) {
          ...
          if (
            recentP.serverUrl == dataServerUrl &&
            recentP.patient.id == patient.id
          ) {
        ...
        if (!alreadyThere) {
          $localStorage.recentPatient.push({
            patient: patient,
      ...
      addToRecentProfile: function (profile, overwrite) {
        ...
        for (var i = 0; i < $localStorage.recentProfile.length; i++) {
          ...
          if (
            recent.profile.url == url &&
            recent.serverUrl == conformanceServerUrl
          ) {
        ...
        if (alreadyThere == -1) {
          //a new profile
          $localStorage.recentProfile.push({
            profile: profile,
            serverUrl: conformanceServerUrl,
          });
        } else {
          //already in the cache - can I overwrite
          if (overwrite) {
            //yes...
            $localStorage.recentProfile[alreadyThere] = {
              profile: profile,
              serverUrl: conformanceServerUrl,
            };
          }
      ...
      setProject: function (project) {
            ...
            query.push(
              $http.get(url).then(
                function (data) {
                  ...
                  recentProfile.push({
                    serverUrl: project.servers.conformance.url,
                    profile: profile,
                  });
                },
                function (err) {
        ...
        $q.all(query).then(function () {
          ...
          that.setRecentPatientForServer(
            recentPatient,
            project.servers.data.url,
          );
      ...
      loadUserConfig: function () {
        ...
        $http.get("artifacts/config.json").then(function (data) {
          ...
          userConfig.projects.forEach(function (project) {
            ...
            project.servers.conformance.server =
              allServersHash[project.servers.conformance.url];
            //project.servers.terminology.server = allServersHash[project.servers.terminology.url];
            project.servers.data.server =
              allServersHash[project.servers.data.url];
          });
