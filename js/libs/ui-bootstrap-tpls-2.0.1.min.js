      ...
      return {
        link: function (d, f, g) {
          function h() {
            (r = !!("horizontal" in g)),
              r
                ? ((s = { width: "auto", height: "inherit" }),
                  (t = { width: "0" }))
                : ((s = { width: "inherit", height: "auto" }),
                  (t = { height: "0" })),
            ...
            (f.hasClass("collapse") && f.hasClass("in")) ||
              b.resolve(n(d)).then(function () {
                f
                  ...
                  .attr("aria-hidden", !1),
                  e
                    ? e(f, { addClass: "in", easing: "ease", to: i(f[0]) })
                        .start()
                        ["finally"](k)
          ...
          if (angular.isNumber(c)) {
            if ("'" === a.charAt(e))
              (e + 1 >= a.length || "'" !== a.charAt(e + 1)) &&
                (d.push(g(a, c, e)), (c = null));
            else if (e === a.length)
              for (; c < a.length; ) (b = h(a, c)), d.push(b), (c = b.endIdx);
            e++;
          } else
            "'" !== a.charAt(e)
              ? ((b = h(a, e)), d.push(b.parser), (e = b.endIdx))
              : ((c = e), e++);
        return d;
      }
      function g(a, b, c) {
      ...
      (this.init = function () {
        ...
        (this.filter = function (a, c) {
          ...
          (c = b.DATETIME_FORMATS[c] || c),
            b.id !== p && this.init(),
            this.formatters[c] || (this.formatters[c] = f(c));
        ...
        (this.parse = function (c, d, f) {
          ...
          if (k && k.length) {
            ...
            angular.isDate(f) && !isNaN(f.getTime())
              ...
              : (f && a.warn("dateparser:", "baseDate is not a valid date"),
                (m = {
                  year: 1900,
                  month: 0,
                  date: 1,
            ...
            return (
              i(m.year, m.month, m.date) &&
                (!angular.isDate(f) || isNaN(f.getTime()) || l
                  ? ((n = new Date(0)),
                    t.call(n, m.year, m.month, m.date),
                    u.call(
                      n,
                      m.hours || 0,
                      m.minutes || 0,
        ...
        (this.toTimezone = k),
        (this.fromTimezone = l),
        (this.timezoneToOffset = m),
        (this.addDateMinutes = n),
        (this.convertTimezoneToLocal = o);
    },
  ]),
  ...
  angular
    ...
    .controller("UibDatepickerController", [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l) {
        ...
        b.addClass("uib-datepicker"),
          ...
          [
            ...
            switch (b) {
              ...
              case "formatYear":
                n[b] = angular.isDefined(a.datepickerOptions[b])
                  ...
                  a
                    ? angular.isDate(a)
                      ...
                      : (j &&
                        ...
                        (n[b] = new Date(h(a, "medium"))))
                    : (n[b] = i[b]
                        ? l.fromTimezone(new Date(i[b]), p.timezone)
                        : null),
                    n.refreshView();
                });
                break;
                      ...
                      function (c) {
                        (n[b] = a[b] =
                          ...
                          (("minMode" === b &&
                            ...
                            ((a.datepickerMode = n[b]),
                            (a.datepickerOptions.datepickerMode = n[b]));
                      },
                    )
                  : (n[b] = a[b] = i[b] || null);
            }
          ...
          (a.isActive = function (b) {
            return 0 === n.compare(b.date, n.activeDate)
          ...
          (this.createDateObject = function (b, c) {
            ...
            return (
              ...
              n.activeDate &&
                0 === this.compare(g.date, n.activeDate) &&
                (a.activeDt = g),
              g
            );
          }),
          ...
          (a.select = function (b) {
            if (a.datepickerMode === n.minMode) {
              ...
              c.setFullYear(b.getFullYear(), b.getMonth(), b.getDate()),
                (c = l.toTimezone(c, p.timezone)),
                o.$setViewValue(c),
                o.$render();
            } else
              (n.activeDate = b),
                m(n.modes[n.modes.indexOf(a.datepickerMode) - 1]),
          ...
          (a.toggleMode = function (b) {
            (b = b || 1),
              (a.datepickerMode === n.maxMode && 1 === b) ||
                (a.datepickerMode === n.minMode && -1 === b) ||
                (m(n.modes[n.modes.indexOf(a.datepickerMode) + b]),
                a.$emit("uib:datepicker.mode"));
          }),
          (a.keys = {
            13: "enter",
        ...
        a.$on("uib:datepicker.focus", r),
          (a.keydown = function (b) {
            var c = a.keys[b.which];
            if (c && !b.shiftKey && !b.altKey && !a.disabled)
              if (
                (b.preventDefault(),
                n.shortcutPropagation || b.stopPropagation(),
                "enter" === c || "space" === c)
              ) {
          ...
          o.$watch("isOpen", function (c, d) {
            if (u && n.dropdownMenu) {
              ...
              if (
                ...
                var x = h.offset(u);
                (e.top = v.top - x.top + "px"),
                  i
                    ? (e.right =
                        window.innerWidth -
                        (v.left - x.left + b.prop("offsetWidth")) +
                        "px")
                    : (e.left = v.left - x.left + "px");
              }
            ...
            if (
              (z === !c &&
                g[c ? "addClass" : "removeClass"](y, u ? p : q).then(
                  function () {
                    ...
                    (l = o.$new()),
                      j(a.trim())(l, function (a) {
                        ...
                        n.dropdownMenu.replaceWith(b),
                          (n.dropdownMenu = b),
                          n.dropdownMenu.on("keydown", f.keybindFilter);
                      });
                  })
                : n.dropdownMenu &&
                  n.dropdownMenu.on("keydown", f.keybindFilter),
        ...
        return (
          ...
          (x.open = function (b, f) {
            ...
            l >= 0 &&
              ...
              f.backdropClass && r.addClass(f.backdropClass),
            ...
            n
              ...
              .html(f.content),
              f.windowClass && n.addClass(f.windowClass),
              f.animation && n.attr("modal-animation", "true"),
              j.addClass(h),
              f.scope && (f.scope.$$topModalIndex = y),
              ...
              switch (b.which) {
                ...
                case 38:
                  (O.activeIdx =
                    ...
                    O.$digest(),
                    (d = T[0].querySelectorAll(".uib-typeahead-match")[
                      O.activeIdx
                    ]),
