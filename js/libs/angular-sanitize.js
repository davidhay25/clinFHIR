...
(function (window, angular, undefined) {
  ...
  var optionalEndTagBlockElements = makeMap("colgroup,dd,dt,li,p"),
  ...
  var blockElements = angular.extend(
    ...
    makeMap(
      "address,article," +
        ...
        "h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,ul",
    ),
  );
  ...
  function htmlParser(html, handler) {
    ...
    while (html) {
      ...
      if (!stack.last() || !specialElements[stack.last()]) {
        ...
        html = html.replace(
          new RegExp("([\\W\\w]*)<\\s*\\/\\s*" + stack.last() + "[^>]*>", "i"),
          function (all, text) {
            text = text
