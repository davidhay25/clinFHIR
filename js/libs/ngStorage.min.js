...
!(function () {
    ...
    return [
      ...
      function (b, c) {
        for (
          ...
          (f = g.key(i)) &&
            "ngStorage-" === f.slice(0, 10) &&
            (h[f.slice(10)] = angular.fromJson(g.getItem(f)));
        return (
          (d = angular.copy(h)),
          b.$watch(function () {
            e ||
              (e = setTimeout(function () {
                if (((e = null), !angular.equals(h, d))) {
                  angular.forEach(h, function (a, b) {
                    angular.isDefined(a) &&
                      "$" !== b[0] &&
                      g.setItem("ngStorage-" + b, angular.toJson(a)),
                      delete d[b];
                  });
          ...
          "localStorage" === a &&
            c.addEventListener &&
            c.addEventListener("storage", function (a) {
              "ngStorage-" === a.key.slice(0, 10) &&
                (a.newValue
                  ? (h[a.key.slice(10)] = angular.fromJson(a.newValue))
                  : delete h[a.key.slice(10)],
                (d = angular.copy(h)),
                b.$apply());
            }),
          h
  ...
  angular
    .module("ngStorage", [])
    .factory("$localStorage", a("localStorage"))
    .factory("$sessionStorage", a("sessionStorage"));
})();
