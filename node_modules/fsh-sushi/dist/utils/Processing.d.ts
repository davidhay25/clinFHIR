...
import { FHIRVersionName } from '../utils/FHIRVersionUtils';
import { RegistryClient } from 'fhir-package-loader';
...
export declare function updateConfig(config: Configuration, program: OptionValues): void;
export declare function updateExternalDependencies(config: Configuration, registryClient: RegistryClient): Promise<boolean>;
...
export declare function writeFHIRResources(outDir: string, outPackage: Package, defs: FHIRDefinitions, snapshot: boolean): {
    skippedResources: string[];
};
export declare function writeFSHIndex(outDir: string, outPackage: Package, inputDir: string, skippedResources?: string[]): void;
