...
class MasterFisher {
    ...
    fishForMetadatas(item, ...types) {
        ...
        return (0, lodash_1.uniqWith)(metadatas, lodash_1.isEqual);
    }
    fixMetadata(metadata, item, types, fishable, fishables) {
        var _a;
        if (metadata) {
            if (fishable instanceof import_1.FSHTank) {
                ...
                if (!metadata.resourceType) {
                    ...
                    if (fshDefinition instanceof fshtypes_1.Instance) {
                        metadata.resourceType = (_a = this.fishForMetadata(fshDefinition.instanceOf)) === null || _a === void 0 ? void 0 : _a.sdType;
                    }
                }
            }
