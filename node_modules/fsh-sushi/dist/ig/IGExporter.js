...
const predefinedResources_1 = require("./predefinedResources");
...
class IGExporter {
    ...
    fixDependsOn(dependency, igs) {
        ...
        let alias = null;
        let realPackageId = (_a = dependsOn.packageId) !== null && _a !== void 0 ? _a : '';
        ...
        if ((_b = dependsOn.version) === null || _b === void 0 ? void 0 : _b.endsWith('.x')) {
            const matchingVersions = igs
                .filter(ig => ig.packageId === realPackageId && ig.version != null)
                .map(ig => ig.version);
            const max = (0, semver_1.maxSatisfying)(matchingVersions, dependsOn.version);
            if (max) {
    ...
    addPredefinedResources() {
        ...
        const configuredBinaryResources = ((_a = this.config.resources) !== null && _a !== void 0 ? _a : []).filter(resource => {
            var _a, _b, _c;
        ...
        const localResourcePaths = (0, predefinedResources_1.getPredefinedResourcePaths)(path_1.default.join(this.inputPath, 'input'), this.inputPath, this.config.parameters);
        const predefinedResourceInfos = this.fhirDefs.findResourceInfos('*', {
            scope: predefinedResources_1.PREDEFINED_PACKAGE_NAME,
            sort: [(0, fhir_package_loader_1.byLoadOrder)(true)] // FIFO order to match previous SUSHI behavior
        });
        const predefinedResources = this.fhirDefs.allPredefinedResources().map(r => (0, lodash_1.cloneDeep)(r));
        ...
        for (let i = 0; i < predefinedResources.length; i++) {
            ...
            if (!localResourcePaths.includes(path_1.default.dirname(file))) {
                deeplyNestedFiles.push(file);
                continue;
            }
            const resourceJSON = predefinedResources[i];
            if (resourceJSON) {
                ...
                if (configuredBinaryReference) {
                    if ((_b = configuredBinaryReference.extension) === null || _b === void 0 ? void 0 : _b.some(ext => ext.url === DEPRECATED_RESOURCE_FORMAT_EXTENSION)) {
                        utils_1.logger.warn(`The extension ${DEPRECATED_RESOURCE_FORMAT_EXTENSION} has been deprecated. Update the configuration for ${(_d = (_c = configuredBinaryReference.reference) === null || _c === void 0 ? void 0 : _c.reference) !== null && _d !== void 0 ? _d : configuredBinaryReference.name} to use the current extension, ${CURRENT_RESOURCE_FORMAT_EXTENSION}.`);
                    }
                    continue;
                }
                ...
                const configResource = ((_e = this.config.resources) !== null && _e !== void 0 ? _e : []).find(resource => { var _a; return ((_a = resource.reference) === null || _a === void 0 ? void 0 : _a.reference) == referenceKey; });
                if ((configResource === null || configResource === void 0 ? void 0 : configResource.omit) !== true) {
                    ...
                    newResource.description =
                        (_h = (_g = (_f = configResource === null || configResource === void 0 ? void 0 : configResource.description) !== null && _f !== void 0 ? _f : metaExtensionDescription) !== null && _g !== void 0 ? _g : existingDescription) !== null && _h !== void 0 ? _h : (0, utils_1.stringOrElse)(resourceJSON.description);
                    ...
                    if (path_1.default.basename(path_1.default.dirname(file)) === 'examples') {
                        newResource.name =
                            (_o = (_m = (_l = (_k = (_j = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _j !== void 0 ? _j : metaExtensionName) !== null && _k !== void 0 ? _k : existingName) !== null && _l !== void 0 ? _l : (0, utils_1.stringOrElse)(resourceJSON.title)) !== null && _m !== void 0 ? _m : (0, utils_1.stringOrElse)(resourceJSON.name)) !== null && _o !== void 0 ? _o : resourceJSON.id;
                        ...
                        if (configResource === null || configResource === void 0 ? void 0 : configResource.exampleCanonical) {
                            ...
                            const exampleUrl = (_q = (_p = resourceJSON.meta) === null || _p === void 0 ? void 0 : _p.profile) === null || _q === void 0 ? void 0 : _q.find(url => {
                                var _a, _b;
                                const [baseUrl, version] = url.split('|', 2);
                                ...
                                return (availableProfile != null &&
                                    (version == null || version === ((_b = availableProfile.version) !== null && _b !== void 0 ? _b : this.config.version)));
                            });
                            if (exampleUrl) {
                                newResource.exampleCanonical = exampleUrl.split('|', 1)[0];
                            }
                        ...
                        newResource.name =
                            (_v = (_u = (_t = (_s = (_r = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _r !== void 0 ? _r : metaExtensionName) !== null && _s !== void 0 ? _s : existingResource === null || existingResource === void 0 ? void 0 : existingResource.name) !== null && _t !== void 0 ? _t : (0, utils_1.stringOrElse)(resourceJSON.title)) !== null && _u !== void 0 ? _u : (0, utils_1.stringOrElse)(resourceJSON.name)) !== null && _v !== void 0 ? _v : resourceJSON.id;
                        newResource._linkRef = (_w = (0, utils_1.stringOrElse)(resourceJSON.name)) !== null && _w !== void 0 ? _w : resourceJSON.id;
                    }
                    if ((_x = configResource === null || configResource === void 0 ? void 0 : configResource.extension) === null || _x === void 0 ? void 0 : _x.length) {
                        newResource.extension = configResource.extension;
                    }
                    if (existingIndex >= 0) {
