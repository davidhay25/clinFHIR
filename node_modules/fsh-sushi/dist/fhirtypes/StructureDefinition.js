...
class StructureDefinition {
     ...
     * @param {Fishable} fisher - A fishable implementation for finding definitions and metadata
     */
    setInstancePropertyByPath(path, value, fisher, inlineResourceTypes = []) {
        ...
        (0, common_1.setPropertyOnDefinitionInstance)(this, path, value, fisher, inlineResourceTypes);
    }
    /**
    ...
    findMatchingSlice(fhirPathString, pathPart, elements, fisher) {
        ...
        if (!matchingSlice &&
            ((_b = pathPart.brackets) === null || _b === void 0 ? void 0 : _b.every(p => p === decodeURIComponent(p))) &&
            ((_c = pathPart.brackets) === null || _c === void 0 ? void 0 : _c.some(p => p !== encodeURIComponent(p)))) {
            const encodedPathPart = (0, cloneDeep_1.default)(pathPart);
