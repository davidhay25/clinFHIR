...
export declare type ValueSetCompose = {
    lockedDate?: string;
    inactive?: boolean;
    include: ValueSetComposeIncludeOrExclude[];
    exclude?: ValueSetComposeIncludeOrExclude[];
};
export declare type ValueSetComposeIncludeOrExclude = {
    system?: string;
    version?: string;
    valueSet?: string[];
...
export declare type ValueSetComposeConcept = {
    code: string;
    display?: string;
    designation?: ValueSetComposeConceptDesignation[];
};
export declare type ValueSetComposeConceptDesignation = {
    language?: string;
    use?: Coding;
    value: string;
};
export declare type ValueSetComposeFilter = {
    property: string;
    op: string;
    value: string;
};
