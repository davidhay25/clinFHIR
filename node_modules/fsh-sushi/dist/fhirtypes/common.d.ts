 ...
 */
export declare function setPropertyOnDefinitionInstance(instance: StructureDefinition | ElementDefinition | CodeSystem | ValueSet, path: string, value: any, fisher: Fishable, inlineResourceTypes?: string[]): void;
/**
 ...
 */
export declare function validateInstanceFromRawValue(target: CodeSystem | ValueSet, rule: CaretValueRule, instanceExporter: InstanceExporter, fisher: Fishable, originalErr: MismatchedTypeError, inlineResourceTypes?: string[]): {
...
export declare function checkForMultipleChoice(fshDef: Profile | Extension | Logical | Resource | FshCodeSystem | FshValueSet | Instance, fhirDef: {
    [key: string]: any;
}, structDef: StructureDefinition): void;
