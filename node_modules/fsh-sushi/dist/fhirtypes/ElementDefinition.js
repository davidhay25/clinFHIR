...
class ElementDefinition {
    ...
    constrainType(rule, fisher, target) {
        ...
        const types = (0, lodash_1.uniqWith)(rule.types, lodash_1.isEqual);
            ...
            if (type.isReference) {
                ...
                matchedType = targetTypes.find(t2 => {
                    ...
                    const matchesProfile = this.getTypeLineage(md.sdType, fisher).some(ancestor => ancestor.sdType === t2.code) &&
                        (((_a = t2.profile) === null || _a === void 0 ? void 0 : _a.includes(md.url)) || ((_b = t2.profile) === null || _b === void 0 ? void 0 : _b.includes(versionedMdUrl)));
