...
class ElementDefinitionType {
    ...
    get code() {
        ...
        return (_b = fhirTypeExtension === null || fhirTypeExtension === void 0 ? void 0 : fhirTypeExtension.valueUrl) !== null && _b !== void 0 ? _b : this._code;
    }
    set code(c) {
        this._code = c;
    }
...
class ElementDefinition {
    ...
    assignValue(value, exactly = false, fisher) {
        ...
        switch (type) {
            ...
            case 'string':
                ...
                break;
            case 'Code':
                this.assignFshCode(value, exactly);
                break;
            case 'Quantity':
                value = value;
            ...
            case 'Canonical':
                ...
                let canonicalUrl = (_a = fisher.fishForMetadata(value.entityName, utils_1.Type.Resource, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension, utils_1.Type.ValueSet, utils_1.Type.CodeSystem, utils_1.Type.Instance)) === null || _a === void 0 ? void 0 : _a.url;
                if (!canonicalUrl) {
            ...
            case 'InstanceDefinition':
                ...
                this.assignFHIRValue(stringVal, value.toJSON(), exactly, (_b = value._instanceMeta.sdType) !== null && _b !== void 0 ? _b : value.resourceType);
                break;
            default:
                type = (_d = (typeof value === 'object' && ((_c = value.constructor) === null || _c === void 0 ? void 0 : _c.name))) !== null && _d !== void 0 ? _d : type;
     ...
     */
    assignFshCode(code, exactly = false) {
        var _a, _b;
