...
exports.checkForMultipleChoice = checkForMultipleChoice;
 ...
 */
function setPropertyOnDefinitionInstance(instance, path, value, fisher, inlineResourceTypes = []) {
    const instanceSD = instance.getOwnStructureDefinition(fisher);
    const { assignedValue, pathParts } = instanceSD.validateValueAtPath(path, value, fisher, inlineResourceTypes);
                ...
                if (i < pathParts.length - 1) {
                    ...
                    if (current[key] != null && typeof current[key] === 'object') {
                        ...
                        if (pathPart.primitive && typeof assignedValue === 'object') {
                            ...
                            if (!(0, lodash_1.isEmpty)(assignedValue)) {
...
function isModifierExtension(extension) {
    var _a, _b;
    return (((_b = (_a = extension === null || extension === void 0 ? void 0 : extension.snapshot) === null || _a === void 0 ? void 0 : _a.element.find((el) => el.id === 'Extension')) === null || _b === void 0 ? void 0 : _b.isModifier) === true);
}
/**
 ...
 */
function validateInstanceFromRawValue(target, rule, instanceExporter, fisher, originalErr, inlineResourceTypes = []) {
    ...
    if (instance == null) {
        ...
        try {
            ...
            const { pathParts } = targetSD.validateValueAtPath(path, instance, fisher, inlineResourceTypes);
...
function checkForMultipleChoice(fshDef, fhirDef, structDef) {
    checkChildrenForMultipleChoice(fshDef, fhirDef, structDef.elements[0]);
}
function checkChildrenForMultipleChoice(fshDef, instance, element) {
    ...
    children.forEach(child => {
        ...
        if (child.id.endsWith('[x]')) {
            ...
            const availableChoices = child.type.map(edType => `${idStart}${(0, lodash_1.upperFirst)(edType.code)}`);
            if (availableChoices.length > 1) {
                ...
                if (existingChoices.length > 1) {
                    utils_1.logger.error(`${fshDef.name} contains multiple choice value assignments for choice element ${child.id}.`, fshDef.sourceInfo);
                }
            }
        }
        ...
        if (instance[childPathEnd] != null && typeof instance[childPathEnd] === 'object') {
            if (Array.isArray(instance[childPathEnd])) {
                instance[childPathEnd].forEach((childProperty) => {
        ...
        if (instance[`_${childPathEnd}`] != null && typeof instance[`_${childPathEnd}`] === 'object') {
            if (Array.isArray(instance[`_${childPathEnd}`])) {
                instance[`_${childPathEnd}`].forEach((childProperty) => {
                    if (childProperty != null && typeof childProperty === 'object') {
                        checkChildrenForMultipleChoice(fshDef, childProperty, child);
                    }
                });
