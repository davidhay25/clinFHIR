            ...
            ctx.entity().forEach(e => {
                ...
                if (e.alias()) {
                    ...
                    if (this.allAliases.has(name) && this.allAliases.get(name) !== value) {
                        FSHLogger_1.logger.error(`Alias ${name} cannot be redefined to ${value}; it is already defined as ${this.allAliases.get(name)}.`, { file: (_a = doc.file) !== null && _a !== void 0 ? _a : '', location: this.extractStartStop(e.alias()) });
