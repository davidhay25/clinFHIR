...
export declare const IMPLIED_EXTENSION_REGEX: RegExp;
/**
 ...
 */
export declare function isImpliedExtension(url: string): boolean;
/**
 ...
 */
export declare function materializeImpliedExtension(url: string, defs: FHIRDefinitions): any;
export declare function materializeImpliedExtensionMetadata(url: string, defs: FHIRDefinitions): Metadata | undefined;
