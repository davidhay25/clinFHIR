...
import { FshCanonical, FshCode, FshQuantity, FshRatio, FshReference, InstanceUsage, ValueSetComponentFrom, ValueSetFilter, ValueSetFilterValue, ParamRuleSet } from '../fshtypes';
import { CardRule, FlagRule, BindingRule, AssignmentRule, AssignmentValueType, OnlyRule, ContainsRule, CaretValueRule, ObeysRule, MappingRule, InsertRule, ConceptRule, ValueSetComponentRule, SdRule, LrRule, AddElementRule } from '../fshtypes/rules';
...
export declare class FSHImporter extends FSHVisitor {
    ...
    visitPathRule(ctx: pc.PathRuleContext): void;
