...
exports.FSHErrorListener = void 0;
...
class FSHErrorListener extends error_1.ErrorListener {
    ...
    buildErrorMessage(recognizer, offendingSymbol, line, column, msg) {
        ...
        let location = {
            ...
            endLine: line,
            endColumn: column + ((_a = offendingSymbol === null || offendingSymbol === void 0 ? void 0 : offendingSymbol.text.length) !== null && _a !== void 0 ? _a : 1)
        };
        ...
        if (/^missing '='/.test(msg) &&
            /^=/.test(offendingSymbol === null || offendingSymbol === void 0 ? void 0 : offendingSymbol.text) &&
        ...
        // > extraneous input 'String"'
            ...
            (/^extraneous input/.test(msg) && /=/.test(oneTokenBack === null || oneTokenBack === void 0 ? void 0 : oneTokenBack.text)) ||
            (/^extraneous input/.test(msg) && /^=/.test(offendingSymbol === null || offendingSymbol === void 0 ? void 0 : offendingSymbol.text))) {
            message =
        ...
        // > KW_INSTANCE, KW_INVARIANT, KW_VALUESET, KW_CODESYSTEM, KW_RULESET, KW_MAPPING, KW_LOGICAL, KW_RESOURCE}
            ...
            (/^\|$/.test(offendingSymbol === null || offendingSymbol === void 0 ? void 0 : offendingSymbol.text) ||
                /^Reference\(/.test(oneTokenBack === null || oneTokenBack === void 0 ? void 0 : oneTokenBack.text) ||
                (/^\(/.test(offendingSymbol === null || offendingSymbol === void 0 ? void 0 : offendingSymbol.text) && /^Reference$/.test(oneTokenBack === null || oneTokenBack === void 0 ? void 0 : oneTokenBack.text)))) {
            message =
        ...
        // > KW_INSTANCE, KW_INVARIANT, KW_VALUESET, KW_CODESYSTEM, KW_RULESET, KW_MAPPING, KW_LOGICAL, KW_RESOURCE}
        else if (/^extraneous input/.test(msg) && /,$/.test(oneTokenBack === null || oneTokenBack === void 0 ? void 0 : oneTokenBack.text)) {
