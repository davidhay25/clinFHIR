...
const allowedRulesMap = new Map([
    ...
    ['Instance', [rules_1.AssignmentRule]],
    ...
    [
        'Logical',
        [rules_1.AddElementRule, rules_1.CardRule, rules_1.CaretValueRule, rules_1.FlagRule, rules_1.ObeysRule, rules_1.OnlyRule, rules_1.BindingRule]
    ],
    [
        'Resource',
        [rules_1.AddElementRule, rules_1.CardRule, rules_1.CaretValueRule, rules_1.FlagRule, rules_1.ObeysRule, rules_1.OnlyRule, rules_1.BindingRule]
