import { Profile, Extension, FshCodeSystem, FshValueSet, Instance, Mapping, RuleSet, Logical, Resource } from '.';
 ...
 */
export declare function isAllowedRule(fshDefinition: Profile | Extension | Logical | Resource | Instance | FshValueSet | FshCodeSystem | Mapping | RuleSet, rule: Rule): boolean;
