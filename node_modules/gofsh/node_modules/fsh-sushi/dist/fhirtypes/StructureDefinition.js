...
class StructureDefinition {
    ...
    validate() {
        ...
        this.elements.forEach(e => {
            e.validate().forEach(err => {
                validationErrors.push(new errors_1.ValidationError(err.issue, `${e.diffId().replace(/(\S):(\S+)/g, (_, c1, c2) => `${c1}[${c2}]`)} ^${err.fshPath}`));
            });
        });
    ...
    findElementByPath(path, fisher) {
        ...
        const parsedPath = PathUtils_1.parseFSHPath(path);
    ...
    validateValueAtPath(path, value, fisher, inlineResourceTypes = []) {
        var _a, _b, _c, _d, _e;
        const pathParts = PathUtils_1.parseFSHPath(path);
        let currentPath = '';
        let previousPath = '';
        let currentElement;
        let previousElement;
        for (const [i, pathPart] of pathParts.entries()) {
            ...
            if (!currentElement && pathPart.base === 'extension') {
                ...
                if (extension && extensionElement) {
                    ...
                    const sliceName = valid_url_1.isUri(pathPart.brackets[0]) ? extension.id : pathPart.brackets[0];
            ...
            if (common_1.isExtension(pathPart.base) &&
                pathPart.slices && (currentElement === null || currentElement === void 0 ? void 0 : currentElement.sliceName) &&
            ...
            const baseIsArray = ((_c = currentElement === null || currentElement === void 0 ? void 0 : currentElement.base) === null || _c === void 0 ? void 0 : _c.max) != null &&
            ...
            if (((_d = currentElement.type) === null || _d === void 0 ? void 0 : _d.length) === 1 &&
            ...
            if (inlineResourceTypes.length > 0 &&
                ...
                ((_e = currentElement.type) === null || _e === void 0 ? void 0 : _e.length) === 1 &&
                ...
                if (inlineResourceJSON) {
                    ...
                    const inlinePath = PathUtils_1.assembleFSHPath(pathParts.slice(i + 1));
                    try {
...
Mixin_1.applyMixins(StructureDefinition, [mixins_1.HasName, mixins_1.HasId]);
/**
