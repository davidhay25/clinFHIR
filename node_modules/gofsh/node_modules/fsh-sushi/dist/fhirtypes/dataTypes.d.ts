import { FHIRDateTime } from './primitiveTypes';
 ...
 */
export declare type BackboneElement = Element & {
 ...
 */
export declare function validatePeriod(period: Period): void;
/**
 ...
 */
export declare type DomainResource = Resource & {
    text?: Narrative;
    contained?: any[];
    extension?: Extension[];
    modifierExtension?: Extension[];
