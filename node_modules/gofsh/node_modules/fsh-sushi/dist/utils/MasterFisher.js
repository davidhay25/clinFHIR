...
const Fishable_1 = require("./Fishable");
        ...
        for (const fishable of fishables) {
            ...
            if (result) {
                ...
                if (fishable instanceof import_1.FSHTank && !result.resourceType) {
                    result.resourceType = (_d = this.fishForMetadata((_c = fishable.fish(item, Fishable_1.Type.Instance)) === null || _c === void 0 ? void 0 : _c.instanceOf)) === null || _d === void 0 ? void 0 : _d.sdType;
                }
                return result;
            }
        }
