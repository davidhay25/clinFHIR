...
exports.loadSupplementalFHIRPackage = exports.loadFromPath = exports.loadCustomResources = exports.cleanCachedPackage = exports.loadDependency = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (packageName.startsWith('hl7.fhir.r5.') && version === 'current') {
            ...
            if (/^hl7\.fhir\.r(4b|5)\./.test(packageName)) {
                try {
                    yield axios_1.default.head(packageUrl);
                }
                catch (_d) {
 ...
 */
function loadSupplementalFHIRPackage(fhirPackage, defs) {
    return __awaiter(this, void 0, void 0, function* () {
