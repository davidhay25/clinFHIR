...
exports.materializeImpliedExtension = exports.isImpliedExtension = exports.IMPLIED_EXTENSION_REGEX = void 0;
...
function materializeImpliedExtension(url, defs) {
    var _a;
    const match = url.match(exports.IMPLIED_EXTENSION_REGEX);
    if (match == null) {
...
function isComplex(fromED, defs) {
    var _a;
    const codes = lodash_1.union((_a = fromED.type) === null || _a === void 0 ? void 0 : _a.map((t) => t.code));
    if (codes.length !== 1) {
    ...
    return defs.fishForFHIR(codes[0], utils_1.Type.Resource, utils_1.Type.Type) == null;
}
/**
...
function applyToValueXElement(fromED, fromVersion, toExt, toED, defs) {
    ...
    if (fromED.binding) {
        ...
        fromED.binding.valueSet) !== null && _a !== void 0 ? _a : fromED.binding.valueSetUri) !== null && _b !== void 0 ? _b : fromED.binding.valueSetReference.reference, fromED.binding.strength);
    ...
    if (fromED.type == null || fromED.type.length === 0) {
        ...
        for (const r3Type of fromED.type) {
            ...
            if (r3Type.profile != null) {
                r4Type.profile = lodash_1.union((_a = r4Type.profile) !== null && _a !== void 0 ? _a : [], [r3Type.profile]);
            }
            if (r3Type.targetProfile != null) {
                r4Type.targetProfile = lodash_1.union((_b = r4Type.targetProfile) !== null && _b !== void 0 ? _b : [], [r3Type.targetProfile]);
            }
            if (r3Type.aggregation != null) {
                r4Type.aggregation = lodash_1.union((_c = r4Type.aggregation) !== null && _c !== void 0 ? _c : [], r3Type.aggregation);
            }
        ...
        for (const r2Type of fromED.type) {
            ...
            if (r2Type.profile != null) {
                if (r2Type.code === 'Reference') {
                    r4Type.targetProfile = lodash_1.union((_d = r4Type.targetProfile) !== null && _d !== void 0 ? _d : [], r2Type.profile);
                }
                else {
                    r4Type.profile = lodash_1.union((_e = r4Type.profile) !== null && _e !== void 0 ? _e : [], r2Type.profile);
                }
            }
            if (r2Type.aggregation != null) {
                r4Type.aggregation = lodash_1.union((_f = r4Type.aggregation) !== null && _f !== void 0 ? _f : [], r2Type.aggregation);
            }
        }
        return r4types;
    }
