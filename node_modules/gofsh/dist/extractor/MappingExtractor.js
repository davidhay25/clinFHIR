...
class MappingExtractor {
    static process(input, elements, fisher) {
        ...
        mappings.forEach(mapping => {
            ...
            mapping.rules = mapping.rules.filter(rule => !(parentMapping === null || parentMapping === void 0 ? void 0 : parentMapping.rules.find(r => (0, lodash_1.isEqual)(r, rule))));
    ...
    static processMappingRule(element, mapping, i) {
        let path = (0, utils_1.getPath)(element);
        if (path === '.')
