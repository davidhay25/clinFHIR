        ...
        [...pkg.profiles, ...pkg.extensions].forEach(sd => {
            ...
            sd.rules.forEach((rule, i, allRules) => {
                if (rule instanceof exportable_1.ExportableCaretValueRule && /(modifierE|e)xtension$/.test(rule.path)) {
                    ...
                    ((0, lodash_1.isEqual)(rule, DEFAULT_SLICING_DISCRIMINATOR_TYPE) ||
                        (0, lodash_1.isEqual)(rule, DEFAULT_SLICING_DISCRIMINATOR_PATH) ||
                        (0, lodash_1.isEqual)(rule, DEFAULT_SLICING_ORDERED) ||
                        (0, lodash_1.isEqual)(rule, DEFAULT_SLICING_RULES)) &&
