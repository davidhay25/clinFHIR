    ...
    optimize(pkg) {
        [
            ...
            if (hasGeneratedText(resource)) {
                (0, lodash_1.remove)(resource.rules, rule => rule instanceof exportable_1.ExportableCaretValueRule &&
                    rule.path === '' &&
        ...
        [...pkg.instances].forEach(instance => {
            if (hasGeneratedText(instance)) {
                (0, lodash_1.remove)(instance.rules, rule => rule instanceof exportable_1.ExportableAssignmentRule && rule.path.match(/^text\./));
            }
        });
    }
};
