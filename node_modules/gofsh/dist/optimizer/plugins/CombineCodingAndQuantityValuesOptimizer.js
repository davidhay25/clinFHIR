...
exports.default = {
    ...
    optimize(pkg, fisher) {
        ...
        [...pkg.profiles, ...pkg.extensions, ...pkg.valueSets, ...pkg.codeSystems].forEach(def => {
            ...
            const ruleMap = {};
            rules
                .filter(r => r instanceof exportable_1.ExportableCaretValueRule)
                .forEach((r) => {
                var _a;
                ruleMap[r.path] = (_a = ruleMap[r.path]) !== null && _a !== void 0 ? _a : {};
            ...
            rules.forEach(rule => {
                if (rule instanceof exportable_1.ExportableCaretValueRule &&
                    ...
                    const siblings = [
                        ...
                        .map(sibling => { var _a; return (_a = ruleMap[rule.path]) === null || _a === void 0 ? void 0 : _a[sibling]; })
                        .filter(Boolean);
                    if (siblings.length) {
