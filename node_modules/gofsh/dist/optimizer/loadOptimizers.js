 ...
 */
async function loadOptimizers(folder) {
    var _a;
    let Optimizers;
    ...
    if (folder == null) {
        ...
        Optimizers = await Promise.resolve().then(() => __importStar(require('./plugins')));
    }
    else {
        ...
        Optimizers = await Promise.resolve(`${relativePath}`).then(s => __importStar(require(s)));
    }
