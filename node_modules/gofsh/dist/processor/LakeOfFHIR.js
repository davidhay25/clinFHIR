...
class LakeOfFHIR {
    constructor(docs) {
        this.docs = docs;
        this.defs = new utils_1.FHIRDefinitions();
    }
    /**
    ...
    async prepareDefs() {
        ...
        const lakePackage = new fhir_package_loader_1.InMemoryVirtualPackage({ name: 'wild-fhir', version: '1.0.0' }, lakeMap, {
            log: (level, message) => {
                (0, utils_1.logMessage)(level, message);
            }
        });
    ...
    removeDuplicateDefinitions() {
        const dupPaths = [];
        this.docs = (0, lodash_1.uniqWith)(this.docs, (a, b) => {
